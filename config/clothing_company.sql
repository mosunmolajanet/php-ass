...
(1, 'Segun Ogungbe', 'Ogungbe01', '12, tanimowo street, oke-ola, Abeokuta.'),
(2, 'Lanre Adeoba', 'Ladeoba', 'No. 1, camp-ground road, anthony housing estate, anthony, Lagos'),
(3, 'Adeola Adetiba', 'Hardext', 'UAMC Eleja primary school, Pahayi, Ilaro'),
(4, 'Yinka Bamidele', 'Yinkus', '12, Lodge street, oke-ado, ibadan');
